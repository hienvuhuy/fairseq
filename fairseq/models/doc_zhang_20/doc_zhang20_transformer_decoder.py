...
from fairseq.models.doc_zhang_20 import DocZhang20TransformerConfig
...
class DocZhang20TransformerDecoder(DocZhang20TransformerDecoderBase):
    def __init__(
        self,
        args,
        dictionary,
    ...
    def build_output_projection(self, args, dictionary, embed_tokens):
        super().build_output_projection(
            DocZhang20TransformerConfig.from_namespace(args), dictionary, embed_tokens
        )

    def build_decoder_layer(self, args, no_encoder_attn=False):
        return super().build_decoder_layer(
            DocZhang20TransformerConfig.from_namespace(args), no_encoder_attn=no_encoder_attn
        )