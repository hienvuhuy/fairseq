...
class DocZhang20TransformerModelBase(FairseqEncoderDecoderModel):
    """
    ...
    def add_args(parser):
        ...
        gen_parser_from_dataclass(
            parser, DocZhang20TransformerConfig(), delete_default=False, with_prefix=""
        )
    ...
    def build_encoder(cls, cfg, src_dict, embed_tokens):
        return DocZhang20TransformerEncoderBase(cfg, src_dict, embed_tokens)

    @classmethod
    def build_decoder(cls, cfg, tgt_dict, embed_tokens):
        return DocZhang20TransformerDecoderBase(
            cfg,
            tgt_dict,
            embed_tokens,
