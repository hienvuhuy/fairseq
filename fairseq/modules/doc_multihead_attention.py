...
# Hien-v: Reuse and develope from multihead_attention.py
import math
...
@with_incremental_state
class DocMultiheadAttention(nn.Module):
    ...
    def forward(
        ...
        if saved_state is not None:
            ...
            key_padding_mask = DocMultiheadAttention._append_prev_key_padding_mask(
                key_padding_mask=key_padding_mask,
