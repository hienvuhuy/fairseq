...
# TODO check this link https://mt.cs.upc.edu/2020/12/21/the-transformer-fairseq-edition/
...
class MyTransformerModel(FairseqEncoderDecoderModel):
    """
    hien-v modified for some purposes
    Transformer model from `"Attention Is All You Need" (Vaswani, et al, 2017)
    <https://arxiv.org/abs/1706.03762>`_.

    Args:
        encoder (MyTransformerEncoder): the encoder
        decoder (MyTransformerDecoder): the decoder
...
class MyTransformerEncoder(FairseqEncoder):
    ...
    is a :class:`MyTransformerEncoder`.
...
@register_model_architecture("mytransformer", "mytransformer")
