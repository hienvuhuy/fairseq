...
from fairseq.models.transformer_clean.transformer_clean_base import (
...
@register_model("transformer_clean", dataclass=TransformerCleanConfig)
class TransformerCleanModel(TransformerCleanModelBase):
    """
    ...
    def __init__(self, args, encoder, decoder):
        cfg = TransformerCleanConfig.from_namespace(args)
    ...
    def build_embedding(cls, args, dictionary, embed_dim, path=None):
        return super().build_embedding(
            TransformerCleanConfig.from_namespace(args), dictionary, embed_dim, path
        )

    @classmethod
    def build_encoder(cls, args, src_dict, embed_tokens):
        return super().build_encoder(
            TransformerCleanConfig.from_namespace(args), src_dict, embed_tokens
        )

    @classmethod
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        return super().build_decoder(
            TransformerCleanConfig.from_namespace(args), tgt_dict, embed_tokens
        )
