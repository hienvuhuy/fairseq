...
class TransformerCorefProbingBertRepresentationBase(nn.Module):
    """Decoder layer block.
...
class TransformerCorefProbingBertRepresentation(TransformerCorefProbingBertRepresentationBase):
    def __init__(
