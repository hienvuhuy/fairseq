...
# hien-v: borrow and modify from the original file
def module_name_fordropout(module_name: str) -> str:
    if module_name == 'DocTransformerEncoderBase':
        return 'DocTransformerEncoder'
    else:
        return module_name


class DocTransformerEncoderBase(FairseqEncoder):
    """
...
class DocTransformerEncoder(DocTransformerEncoderBase):
