...
from fairseq.models.doc_zhang_20.doc_zhang20_transformer_config import (
...
class DocZhang20TransformerModel(DocTransformerModelBase):
    ...
    def __init__(self, args, encoder, decoder):
        cfg = DocZhang20TransformerConfig.from_namespace(args)
    ...
    def build_embedding(cls, args, dictionary, embed_dim, path=None):
        return super().build_embedding(
            DocZhang20TransformerConfig.from_namespace(args), dictionary, embed_dim, path
        )

    @classmethod
    def build_encoder(cls, args, src_dict, embed_tokens):
        return super().build_encoder(
            DocZhang20TransformerConfig.from_namespace(args), src_dict, embed_tokens
        )

    @classmethod
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        return super().build_decoder(
            DocZhang20TransformerConfig.from_namespace(args), tgt_dict, embed_tokens
        )