...
@dataclass
class TranslationCorefProbingWithInferConfig(TranslationConfig):
...
@register_task("translation_coref_probing_with_infer", dataclass=TranslationCorefProbingWithInferConfig)
class TranslationCorefProbingWithInferTask(FairseqTask):
    """
    ...
    cfg: TranslationCorefProbingWithInferConfig

    def __init__(self, cfg: TranslationCorefProbingWithInferConfig, src_dict, tgt_dict):
        super().__init__(cfg)
    ...
    @classmethod
    def setup_task(cls, cfg: TranslationCorefProbingWithInferConfig, **kwargs):
