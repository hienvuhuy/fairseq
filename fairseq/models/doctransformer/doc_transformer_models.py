...
from fairseq.models.doctransformer.doc_transformer_config import (
...
@register_model("doctransformer", dataclass=DocTransformerConfig)
class DocTransformerModel(DocTransformerModelBase):
    """
    ...
    def __init__(self, args, encoder, decoder):
        cfg = DocTransformerConfig.from_namespace(args)
    ...
    def build_embedding(cls, args, dictionary, embed_dim, path=None):
        return super().build_embedding(
            DocTransformerConfig.from_namespace(args), dictionary, embed_dim, path
        )

    @classmethod
    def build_encoder(cls, args, src_dict, embed_tokens):
        return super().build_encoder(
            DocTransformerConfig.from_namespace(args), src_dict, embed_tokens
        )

    @classmethod
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        return super().build_decoder(
            DocTransformerConfig.from_namespace(args), tgt_dict, embed_tokens
        )