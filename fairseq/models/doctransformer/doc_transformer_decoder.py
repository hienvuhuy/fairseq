...
from fairseq.models.doctransformer import DocTransformerConfig
...
def module_name_fordropout(module_name: str) -> str:
    if module_name == 'DocTransformerDecoderBase':
        return 'DocTransformerDecoder'
    else:
        return module_name


class DocTransformerDecoderBase(FairseqIncrementalDecoder):
    """
...
class DocTransformerDecoder(DocTransformerDecoderBase):
    def __init__(
        self,
        args,
        dictionary,
    ...
    def build_output_projection(self, args, dictionary, embed_tokens):
        super().build_output_projection(
            DocTransformerConfig.from_namespace(args), dictionary, embed_tokens
        )

    def build_decoder_layer(self, args, no_encoder_attn=False):
        return super().build_decoder_layer(
            DocTransformerConfig.from_namespace(args), no_encoder_attn=no_encoder_attn
        )
