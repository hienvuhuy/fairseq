...
def module_name_fordropout(module_name: str) -> str:
    if module_name == 'DocZhang20TransformerEncoderBase':
        return 'DocZhang20TransformerEncoder'
    else:
        return module_name


class DocZhang20TransformerEncoderBase(FairseqEncoder):
    """
...
class DocZhang20TransformerEncoder(DocZhang20TransformerEncoderBase):
